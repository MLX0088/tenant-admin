...
import com.tenant.common.config.MinioConfig;
import com.tenant.common.config.TenantConfig;
import com.tenant.common.constant.Constants;
import com.tenant.common.exception.file.FileNameLengthLimitExceededException;
import com.tenant.common.exception.file.FileSizeLimitExceededException;
import com.tenant.common.exception.file.InvalidExtensionException;
import com.tenant.common.utils.DateUtils;
import com.tenant.common.utils.StringUtils;
import com.tenant.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 本地默认上传的地址
     */
    private static String defaultBaseDir = TenantConfig.getProfile();
...
//        assertAllowed(file, allowedExtension);
     ...
     * @throws Exception
     */
    public static final void removeMinio(String obj) throws IOException
    {
        try
        {
            MinioUtil.remove(getBucketName(),obj);
        }
        catch (Exception e)
        {
            throw new IOException(e.getMessage(), e);
    ...
    {
        int dirLastIndex = TenantConfig.getProfile().length() ;

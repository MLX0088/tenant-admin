package com.tenant.framework.web.exception;
...
import com.tenant.common.exception.DemoModeException;
...
//        response.setStatus(HttpStatus.FORBIDDEN.value());     用不到 统一返回200,用code来判断
        if (ServletUtils.isAjaxRequest(request)|| ShiroUtils.getSysUser().getUserType().equals(UserConstants.REGISTER_USER_TYPE))   //接口请求
        {

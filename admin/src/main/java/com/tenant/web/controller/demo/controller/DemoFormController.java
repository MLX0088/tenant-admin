package com.tenant.web.controller.demo.controller;
...
import com.tenant.common.json.JSONObject;
import com.tenant.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "tenant 1", "tenant 2", "tenant 3", "tenant 4", "tenant 5" };
        AjaxResult ajax = new AjaxResult();

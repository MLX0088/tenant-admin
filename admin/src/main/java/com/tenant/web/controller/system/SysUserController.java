...
import com.tenant.framework.shiro.util.AuthorizationUtils;
import com.tenant.system.service.ISysDeptService;
import com.tenant.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    @GetMapping()
    public String user(String a,ModelMap mmap)
    {
        mmap.put("a",a);
        return prefix + "/user";
    }
    ...
    public AjaxResult statistics(){
        ...
        user.setDeptId(getTenantId());
        Map<String,Object> mapUser = userService.statisticsDashboardRecord(user);
    ...
    public String edit(@PathVariable("userId") Long userId, @RequestParam(value = "index",required = false) Integer index, ModelMap mmap)
    {
    ...
    @ResponseBody
    public AjaxResult updateHeadImage(SysUser user)
    {
        SysUser curuser = ShiroUtils.getSysUser() ;
        if(curuser.getUserId() == user.getUserId()){
            curuser.setHeadImageId(user.getHeadImageId());
        }
        return toAjax(userService.updateHeadImage(user));
    }

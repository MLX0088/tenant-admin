...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            submitWithoutAlert: function(url, type, dataType, data, callback) {
                var config = {
                    url: url,
                    type: type,
                    dataType: dataType,
...
//                        $.modal.loading("正在处理中，请稍候...");
            ...
            // post请求传输
            postWithoutAlert: function(url, data, callback) {
                $.operate.submitWithoutAlert(url, "post", "json", data, callback);
            },
            // get请求传输
            get: function(url, callback) {
                $.operate.submitWithoutAlert(url, "get", "json", "", callback);
            },
            // 详细信息
            ...
            // 修改信息
            editWithSize: function(id,width,height) {
                table.set();
                if(!width){
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
                    ...
                    var topWindow = $('.tenant_iframe[data-id="' + currentId + '"]', topWindow)[0];
